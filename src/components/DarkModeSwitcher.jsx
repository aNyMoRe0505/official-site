...
const DarkModeSwitcherWrap = styled.div`
  width: 50px;
  height: 24px;
  border-radius: 30px;
...
const DarkModeSwitcherIcon = styled.img`
  width: 17px;
  height: 17px;
  ${({ moon }) => (moon && 'left: 5px') || 'right: 5px'};
  position: absolute;
  top: 0;
  bottom: 0;
  margin: auto 0;
...
const DarkModeToggleBtn = styled.div`
  width: 22px;
  height: 22px;
  border-radius: 50%;
  ...
  left: 1px;
  z-index: 2;
  transform: ${({ darkMode }) => (darkMode && 'translateX(26px)') || 'translateX(0px)'};
